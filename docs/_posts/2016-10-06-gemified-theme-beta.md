...
[`ynievesdotnet-jekyll`](https://rubygems.org/gems/ynievesdotnet-jekyll) can only be used with Jekyll proper. If you're hosting on GitHub Pages or using that gem the theme won't work. 3rd party themes haven't been white-listed so it's a no go for now.
...
Add `theme: "ynievesdotnet-jekyll"` to your `_config.yml` file.
...
- Replace `<site root>/index.html` with a modified [Minimal Mistakes `index.html`](https://github.com/ynievesdotnet/ynievesdotnet/blob/master/index.html).
...
[File an issue](https://github.com/ynievesdotnet/ynievesdotnet/issues/new){: .btn .btn--info .btn--large}
