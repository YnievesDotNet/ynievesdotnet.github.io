...
The theme's `assets/css/main.css` file is built from several SCSS partials located in [`_sass/`](https://github.com/ynievesdotnet/ynievesdotnet/tree/master/_sass) and is structured as follows:
...
1. Copy directly from the Minimal Mistakes theme gem
   ...
   - Go to your local Minimal Mistakes gem installation directory (run 
     `bundle show ynievesdotnet-jekyll` to get the path to it).
...
2. Copy from this repo.
   ...
   - Copy the contents of [assets/css/main.scss](https://github.com/ynievesdotnet/ynievesdotnet/blob/master/assets/css/main.scss) 
     to `<your_project>`.
   - Customize what you want inside `<your_project/assets/css/main.scss`.
...
**1.** Add this Google Fonts script to [`_includes/head/custom.html`](https://github.com/ynievesdotnet/ynievesdotnet/blob/master/_includes/head/custom.html):
