...
<!--
  ...
  Copyright 2013-2020 Michael Rose - mademistakes.com | @ynievesdotnet
  Free for personal and commercial use under the MIT license
  https://github.com/ynievesdotnet/ynievesdotnet/blob/master/LICENSE
-->
```
...
Simply run `bundle update` if you're using Bundler (have a `Gemfile`) or `gem update ynievesdotnet-jekyll` if you're not.

When using Bundler you can downgrade or lock the theme to a specific release ([tag](https://github.com/ynievesdotnet/ynievesdotnet/tags)), branch, or commit. Instead of `gem "ynievesdotnet-jekyll"` you'd add the following to your `Gemfile`:

```ruby
gem "ynievesdotnet-jekyll", :git => "https://github.com/ynievesdotnet/ynievesdotnet.git", :tag => "4.19.1"
```
...
When setting `remote_theme: "ynievesdotnet/ynievesdotnet@4.19.1"` in your `_config.yml` you may also optionally specify a branch, [tag](https://github.com/ynievesdotnet/ynievesdotnet/tags), or commit to use by appending an @ and the Git ref.

For example you can roll back to release 4.8.1 with `ynievesdotnet/ynievesdotnet@4.8.1` or a specific commit with `ynievesdotnet/ynievesdotnet@bbf3cbc5fd64a3e1885f3f99eb90ba92af84063d`). For a complete list of theme versions consult the [releases page](https://github.com/ynievesdotnet/ynievesdotnet/releases).
