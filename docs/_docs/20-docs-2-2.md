...
1. Fork the [Minimal Mistakes repo](http://github.com/ynievesdotnet/ynievesdotnet/fork).
...
1. [Download Minimal Mistakes](https://github.com/ynievesdotnet/ynievesdotnet/releases/tag/2.2.1) and unzip.
2. Rename `ynievesdotnet-master` to something meaningful ie: `new-site`
...
```yaml
url: http://ynievesdotnet.github.io/ynievesdotnet
