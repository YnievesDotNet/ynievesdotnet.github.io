...
**If you enjoy this theme, please consider [supporting me](https://www.paypal.me/ynievesdotnet) for developing and maintaining it.**
...
You may also optionally specify a branch, [tag](https://github.com/ynievesdotnet/ynievesdotnet/tags), or commit to use by appending an @ and the Git ref (e.g., `ynievesdotnet/ynievesdotnet@4.9.0` or `ynievesdotnet/ynievesdotnet@bbf3cbc5fd64a3e1885f3f99eb90ba92af84063d`). This is useful when rolling back to older versions of the theme. If you don't specify a Git ref, the latest on `master` will be used.
...
To do so fork the [Minimal Mistakes theme](https://github.com/ynievesdotnet/ynievesdotnet/fork), then rename the repo to **USERNAME.github.io** --- replacing **USERNAME** with your GitHub username.
...
If you forked or downloaded the `ynievesdotnet-jekyll` repo you can safely remove the following folders and files:
...
- `/test`
- `CHANGELOG.md`
- `ynievesdotnet-jekyll.gemspec`
- `README.md`
- `screenshot-layouts.png`
- `screenshot.png`

**Note:** If forking the theme be sure to update `Gemfile` as well. The one found at the root of the project is for building the theme's Ruby gem and is missing dependencies. To properly setup a [`Gemfile`](https://github.com/ynievesdotnet/ynievesdotnet/blob/master/docs/Gemfile) with the theme, consult the "[Install Dependencies](https://ynievesdotnet.github.io/ynievesdotnet/docs/installation/#install-dependencies)" section.
{: .notice--warning}
...
**ProTip:** The source code and content files for this site can be found in the [`/docs` folder](https://github.com/ynievesdotnet/ynievesdotnet/tree/master/docs) if you want to copy or learn from them.
{: .notice--info}

### Starting Fresh

Starting with an empty folder and `Gemfile` you'll need to copy or re-create this [default `_config.yml`](https://github.com/ynievesdotnet/ynievesdotnet/blob/master/_config.yml) file. For a full explanation of every setting be sure to read the [**Configuration**]({{ "/docs/configuration/" | relative_url }}) section.
...
- [`_data/ui-text.yml`](https://github.com/ynievesdotnet/ynievesdotnet/blob/master/_data/ui-text.yml) - UI text [documentation]({{ "/docs/ui-text/" | relative_url }})
- [`_data/navigation.yml`](https://github.com/ynievesdotnet/ynievesdotnet/blob/master/_data/navigation.yml) - navigation [documentation]({{ "/docs/navigation/" | relative_url }})
...
- Replace `<site root>/index.md` with a modified [Minimal Mistakes `index.html`](https://github.com/ynievesdotnet/ynievesdotnet/blob/master/index.html). Be sure to enable pagination if using the [`home` layout]({{ "/docs/layouts/#home-page" | relative_url }}) by adding the necessary lines to **_config.yml**.
...
**Note:** When clearing out the `assets` folder be sure to leave any files you've added and need. This includes images, CSS, or JavaScript that aren't already [bundled in the theme](https://github.com/ynievesdotnet/ynievesdotnet/tree/master/assets). 
{: .notice--warning}
...
Then run `bundle update` and add `theme: ynievesdotnet-jekyll` to your `_config.yml`.
